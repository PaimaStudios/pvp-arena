...
export class PracticeMenu extends Phaser.Scene {
    ...
    create() {
        ...
        this.status = new StatusUI(this, [
            new Button(this, GAME_WIDTH / 2, GAME_HEIGHT * 0.3, 128, 32, 'On-chain Practice', 12, () => {
            ...
            new Button(this, GAME_WIDTH / 2, GAME_HEIGHT * 0.5, 128, 32, 'Offline Practice', 12, () => {
                this.status!.setText('Entering mocked test arena...');
                setTimeout(() => {
                    this.scene.remove('EquipmentMenu');
